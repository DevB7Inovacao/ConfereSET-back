...
namespace Services
{
	public class EmpresasService : IEmpresasService
	{
		...
		public async Task<Result> CreateEmpresa(Empresas empresas)
		{
			try
			{
				if (empresas == null)
	...
	!ValidarCNPJ(empresas.CNPJ)
				...
				_unitOfWork.Save();
				return new Result { Success = true, Message = "Empresa criada com sucesso.", Data = empresas };
			}
			catch (Exception ex)
			{
	...
	public interface IEmpresasService
	{
		...
		public Task<Result> CreateEmpresa(Empresas empresas);
